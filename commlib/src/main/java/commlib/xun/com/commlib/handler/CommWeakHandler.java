package commlib.xun.com.commlib.handler;
...
public class CommWeakHandler {
    ...
    /**
     * Constructor associates this handler with the {@link Looper} for the current thread and takes a callback
     ...
     * be received in callback, in the thread attached to this handler.
     *
     * @return Returns true if the message was successfully placed in to the message queue. Returns false on failure,
     * usually because the looper processing the message queue is exiting.
     */
     ...
     * it in callback, in the thread attached to this handler.
     *
     ...
     * . You will receive it in callback, in the thread attached to this handler. <b>This method is only for use in
